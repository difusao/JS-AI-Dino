...
(function () {
    ...
    function TrexGroup(canvas, spritePos) {
    };
    ...
    Horizon.prototype = {
        ...
        updateObstacles: function (deltaTime, currentSpeed) {
            ...
            if (this.obstacles.length > 0) {
                ...
                // var obsPosX = this.obstacles[0].xPos / 100;
                // var obsPosY = this.obstacles[0].yPos / 100;
                // var obsH = this.obstacles[0].height / 100;
                // var obsW = this.obstacles[0].width / 100;
                // var obsSpd = currentSpeed / 10;
                // var obsScore = scoreIA / 10;
...
function onDocumentLoad() {
    ...
    new Runner('.interstitial-wrapper', optconfig);
}
